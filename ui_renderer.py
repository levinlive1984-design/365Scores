    ...
    st.markdown("""
        <style>
            ...
            [data-testid="stSidebar"] .stButton > button {
                background: transparent !important; border: none !important; color: #d32f2f !important; 
                font-weight: 900 !important; font-size: 1.15em !important; display: flex !important; align-items: center !important;
            }
...
def get_table_html(title, data_list):
    if not data_list: return "<div>📡 無數據載入</div>"
    ...
    for row in data_list:
        ...
        html += f"<td style='padding: 10px 12px; {status_style}'>{row['Status']}</td>"
